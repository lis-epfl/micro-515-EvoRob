#!/bin/bash
#SBATCH --job-name=ER_Challenge1b                # Job name
#SBATCH --output=logs/ER_Challenge1b_%j.out      # Standard output file (%j will be replaced by the job ID)
#SBATCH --error=logs/ER_Challenge1b_%j.err       # Standard error file
