...
def run_hybrid_evolution(
    ...
    obs_dim = 27
    action_dim = 8
    phase_feat_dim = 2  # sin + cos for each joint
    ...
    print(f"Initial frequency   : {phase_info['frequency']:.4f}")
    print(f"Initial phase       : {phase_info['phase']:.4f}")
    print("=" * 72)
    ...
    for generation in range(num_generations):
        ...
        print(f"  Frequency: {phase_info['frequency']:.4f}")
        print(f"  Phase    : {phase_info['phase']:.4f}")
