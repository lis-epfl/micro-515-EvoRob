...
Submit these documents in a single zipped folder to Moodle at `Submission - Challenge 1` with the following naming convention: `2026_micro_515_SCIPER_TEAMNAME_LASTNAME1_LASTNAME2.zip`. One submission per team is sufficient.
